...
if __name__ == "__main__":
    ...
    Sqrt = Button(gui, text=' √ ', fg='black', bg='grey', command=lambda: press("sqrt"), height=1, width=7)
    Sqrt.grid(row=5, column=2)

    quadrat = Button(gui, text=' ^ ', fg='black', bg='grey', command=lambda: press("**"), height=1, width=7)
    quadrat.grid(row=1, column=2)
